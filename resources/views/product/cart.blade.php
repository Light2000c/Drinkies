                ...
                <div class="table-responsive shopping-summery">
                    <table class="table table-wishlist">
                        ...
                        <tbody>
                            ...
                            <tr class="pt-30">
                                <td class="image product-thumbnail pt-40"><img src="products/{{ $cart->product->product_image }}" alt="#"></td>
                                <td class="product-des product-name">
                                    <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="shop-product-right.html">{{ $cart->product->product_name }}</a></h6>
                                </td>
                                <td class="price" data-title="Price">
                                    <h4 class="text-body">₦{{ number_format($cart->product->product_price,2) }}</h4>
                                </td>
                                ...
                                <td class="action text-center" data-title="Remove">
                                    <form action="{{ route('remove_from_cart', $cart->product) }}" method="post">
                                        @csrf
                                        @method('delete')
                            ...
                            {{-- <tr>
                                ...
                                <td class="image product-thumbnail"><img src="web1/assets/imgs/shop/product-2-1.jpg" alt="#"></td>
                                <td class="product-des product-name">
                            ...
                            <tr>
                                ...
                                <td class="image product-thumbnail"><img src="web1/assets/imgs/shop/product-3-1.jpg" alt="#"></td>
                                <td class="product-des product-name">
